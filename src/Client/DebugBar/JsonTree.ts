...
export const jsonTree = window["jsonTree"] = (function() {
        ...
        let self = this,
            ...
            template = function(label, val) {
                ...
                "<span class=\"jsontree_value-wrapper\">" +
                    "<span class=\"jsontree_value jsontree_value_\"" + self.type + "\">" + val +
                    "</span>" +
                    (!isLast ? "," : "") +
                    "</span>";
    ...
    function _NodeComplex(label, val, isLast) {
        ...
        utils.forEachNode(val, function(label, node, isLast) {
            self.addChild(Node(label, node, isLast));
        });
    ...
    Tree.prototype = {
        ...
        loadData : function(jsonObj) {
            ...
            this.rootNode = Node(null, jsonObj, "last");
